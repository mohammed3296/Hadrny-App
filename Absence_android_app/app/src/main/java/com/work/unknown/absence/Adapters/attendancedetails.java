...
public class attendancedetails extends RecyclerView.Adapter<sesstionadapter.sesstionholder>{
    ArrayList<sesstion> userList=new ArrayList<>();
    Context context;
    public attendancedetails(ArrayList<sesstion> userList, Context context) {
    ...
    public void onBindViewHolder(sesstionadapter.sesstionholder holder, int position) {
        ...
        holder.sesstionname.setOnClickListener(new View.OnClickListener() {
            @Override
